...
namespace Captcha.Cryptography
{
    ...
    class AES
    {
        ...
        {
            string strKey = "1b55ec1d96f637aa7b73c31765a12c2c8fb8b9f6ae8b14396475a20ed1a83dac";
            return strKey;
        } // End Sub GetKey
        ...
        {
            string strIV = "d4e3381cdd39ddb70f85e96d11b667e5";
            return strIV;
        } // End Sub GetIV
    ...
    class DES
    {
        ...
        //protected static string strSymmetricKey = "Als symmetrischer Key kann irgendein Text verwendet werden. äöü'";


        public static string GetSymmetricKey()
        {
            return "z67f3GHhdga78g3gZUIT(6/&ns289hsB_5Tzu6";
        }
